 ...
 *
 * application 레이어의 {@link com.notification.application.port.out.NotificationEventPublisher} 포트를 구현한다.
 * Spring 내부 이벤트 버스를 사용하므로 JVM 내부 통신이며, 외부 메시지 브로커가 아니다.
 * 추후 Kafka 등으로 교체 시 이 클래스만 바꾸면 된다.
 */
@Component
@RequiredArgsConstructor
public class SpringEventNotificationPublisher implements NotificationEventPublisherPort {
